...
{
    UpdateData(TRUE); 
    NET_DVR_FINGER_PRINT_INFO_CTRL struDelCfg;
    memset(&struDelCfg, 0, sizeof(NET_DVR_FINGER_PRINT_INFO_CTRL));
    struDelCfg.dwSize = sizeof(NET_DVR_FINGER_PRINT_INFO_CTRL);
