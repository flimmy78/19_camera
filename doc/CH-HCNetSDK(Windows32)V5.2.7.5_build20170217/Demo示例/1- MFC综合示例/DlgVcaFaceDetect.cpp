...
BOOL CDlgVcaFaceDetect::OnInitDialog() 
{
	...
	g_StringLanType(szLan, "异常人脸", "Abnormal");
	m_comboEventType.InsertString(index, szLan);
	m_comboEventType.SetItemData(index, 0);
    index++;
	
	g_StringLanType(szLan, "正常人脸", "Normal");
	m_comboEventType.InsertString(index, szLan);
	m_comboEventType.SetItemData(index, 1);
    index++;
	
	g_StringLanType(szLan, "异常人脸&正常人脸", "Abnormal&Normal");
	m_comboEventType.InsertString(index, szLan);
	m_comboEventType.SetItemData(index, 2);
    index++;
	
	g_StringLanType(szLan, "多张人脸&异常人脸", "Multi&Abnormal");
	m_comboEventType.InsertString(index, szLan);
	m_comboEventType.SetItemData(index, 4);
    index++;
	
	g_StringLanType(szLan, "多张人脸&正常人脸", "Multi&Normal");
	m_comboEventType.InsertString(index, szLan);
	m_comboEventType.SetItemData(index, 5);
    index++;
	
	g_StringLanType(szLan, "多张人脸&异常人脸&正常人脸", "Multi&Abnormal&Normal");
	m_comboEventType.InsertString(index, szLan);
	m_comboEventType.SetItemData(index, 6);
    index++;
	
	g_StringLanType(szLan, "多张人脸", "Multi");
	m_comboEventType.InsertString(index, szLan);
	m_comboEventType.SetItemData(index, 7);
    index++;
...
void CDlgVcaFaceDetect::GetFaceDetectRuleFromWnd(NET_DVR_FACEDETECT_RULECFG_V41& struFaceDetectRule)
{
	...
	struFaceDetectRule.byEventType = m_comboEventType.GetItemData(m_comboEventType.GetCurSel());
...
void CDlgVcaFaceDetect::SetFaceDetectRuleToWnd(NET_DVR_FACEDETECT_RULECFG_V41 const &struFaceDetectRule)
{
	...
	int i;
	for (i = 0; i < m_comboEventType.GetCount(); i++)
    {
        if (struFaceDetectRule.byEventType == m_comboEventType.GetItemData(i))
        {
            m_comboEventType.SetCurSel(i);
            break;
        }
    }
