...
BEGIN_MESSAGE_MAP(CDlgProductAlarmHostCfg, CDialog)
	...
	ON_BN_CLICKED(IDC_BTN_DH3, OnBtnDh3)
	ON_BN_CLICKED(IDC_BTN_SCALE_OUT_CFG, OnBtnScaleOutCfg)
	ON_BN_CLICKED(IDC_BTN_ALARM_CHAN_ABLITITY, OnBtnAlarmChanAblitity)
	ON_BN_CLICKED(IDC_BTN_ALARM_CENTER, OnBtnAlarmCenter)
	ON_BN_CLICKED(IDC_BTN_IDS, OnBtnIDSMainBorad)
    ...
    ON_BN_CLICKED(IDC_BTN_NETCARD_CFG, &CDlgProductAlarmHostCfg::OnBnClickedBtnNetcardCfg)
	//}}AFX_MSG_MAP
...
void CDlgProductAlarmHostCfg::InitZoneSignalTypeCombo()
{
    char szLan[128] = { 0 };
...
BOOL CDlgProductAlarmHostCfg::SetAlarmInParam(NET_DVR_ALARMIN_PARAM_V50& struAlarmInParam)
{
...
BOOL CDlgProductAlarmHostCfg::GetAlarmInParam(NET_DVR_ALARMIN_PARAM_V50& struAlarmInParam)
{
    BOOL bRet = FALSE;
    LONG lAlarmIn = m_comboAlarmIn.GetItemData(m_comboAlarmIn.GetCurSel());
    DWORD dwReturn = 0;
...
// }
// 
void CDlgProductAlarmHostCfg::SetAlarmInParamToWnd(NET_DVR_ALARMIN_PARAM_V50& struAlarmInParam)
{
    int i = 0;
...
void CDlgProductAlarmHostCfg::GetAlarmInParamFromWnd(NET_DVR_ALARMIN_PARAM_V50& struAlarmInParam)
{
    int i = 0;
    for (i = 0; i < m_listAlarmOut.GetItemCount(); i++)
    {
    ...
    struAlarmInParam.byType = (m_comboDefenseType.GetCurSel()>9)?0xff:m_comboDefenseType.GetCurSel();
...
void CDlgProductAlarmHostCfg::OnSelchangeCmbZoneResistor() 
{
	// TODO: Add your control notification handler code here
	if (m_cmbZoneResistor.GetCurSel() == 6)
	{
...
void CDlgProductAlarmHostCfg::OnBtnDh3() 
{
	// TODO: Add your control notification handler code here
	DlgDH3 dlg;
	dlg.DoModal();
...
void CDlgProductAlarmHostCfg::OnBtnScaleOutCfg() 
{
	// TODO: Add your control notification handler code here
	CDlgScaleOutCfg dlg;
	dlg.DoModal();
...
void CDlgProductAlarmHostCfg::OnBtnIDSMainBorad() 
{
	// TODO: Add your control notification handler code here
	CDlgIDSMainBoard dlg;
	dlg.DoModal();
}
...
void CDlgProductAlarmHostCfg::OnBnClickedBtnNetcardCfg()
{
	// TODO: Add your control notification handler code here
