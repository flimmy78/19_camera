...
void CDlgPanoramaImage::OnBtnSensorInfo()
{
    ...
    sprintf(szAdjustmentInfo, "dwSize:%d,iPan:%d,iTilt:%d,iRotation:%d,iFieldAngle:%d,RgbType:%d,R:%d,G:%d,B:%d", \
        ...
        m_struSensorAdjustmentInfo.byR, m_struSensorAdjustmentInfo.byG, m_struSensorAdjustmentInfo.byB);
