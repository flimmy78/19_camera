...
void CDlgInfrareCfg::OnBtnFocusmodeSet() 
{
	...
	if (!NET_DVR_SetDVRConfig(g_struDeviceInfo[m_iDevIndex].lLoginID, NET_DVR_SET_FOCUSMODECFG, 1, &struFocusModeCfg, sizeof(struFocusModeCfg)))
    {
...
void CDlgInfrareCfg::OnBtnFocusmodeGet() 
{
	...
	if (!NET_DVR_GetDVRConfig(g_struDeviceInfo[m_iDevIndex].lLoginID, NET_DVR_GET_FOCUSMODECFG, 1, &struFocusModeCfg, sizeof(struFocusModeCfg), &dwReturn))
    {
