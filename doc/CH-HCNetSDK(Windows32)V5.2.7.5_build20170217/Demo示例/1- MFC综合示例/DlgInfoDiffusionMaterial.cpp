...
void CDlgInfoDiffusionMaterial::OnBtnClock() 
{
	// TODO: Add your control notification handler code here

	CDlgInfoDiffusionClock dlg;
	dlg.m_struMaterial = &m_struMaterial;
	dlg.DoModal();
	
}

void CDlgInfoDiffusionMaterial::OnBtnWeather() 
{
	// TODO: Add your control notification handler code here
	CDlgInfoDiffusionClockWeather dlg;
	dlg.m_struMaterial = &m_struMaterial;
	dlg.DoModal();
}
