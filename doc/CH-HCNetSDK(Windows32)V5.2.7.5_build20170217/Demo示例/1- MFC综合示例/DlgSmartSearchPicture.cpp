...
void CDlgSmartSearchPicture::GetFindPictureParamFromWnd()
{
   ...
   // memset(&m_struSmartPic, 0,sizeof(m_struSmartPic));
    ...
    case 0:
        ...
        if (m_comboCountry.GetCurSel() < 13)
        {
            m_struSmartPic.uSmartSearchCond.struVehiclePara.byCountry = m_comboCountry.GetCurSel();
        }
        else
        {
            m_struSmartPic.uSmartSearchCond.struVehiclePara.byCountry = 0xfe;
        }
        break;
