...
void CDlgCcdParam::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Control(pDX, IDC_COMBO_ZoomInDisLevel, m_comZoomedInDistantViewLevel);
    DDX_Check(pDX, IDC_CHECK_ZoomedInDistantView, m_bZoomedInDistantView);
  }
...
void CDlgCcdParam::OnBtnGetEx() 
{
    ...
    m_bZoomedInDistantView = m_CcdParamEx.byZoomedInDistantView;
    m_comZoomedInDistantViewLevel.SetCurSel(m_CcdParamEx.byZoomedInDistantViewLevel);
...
void CDlgCcdParam::OnBtnSetEx() 
{
    ...
    m_CcdParamEx.byZoomedInDistantView = m_bZoomedInDistantView;
    m_CcdParamEx.byZoomedInDistantViewLevel = m_comZoomedInDistantViewLevel.GetCurSel();
