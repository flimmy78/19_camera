...
void CDlgVideoIntercomElevatorCfg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_FLOOR, m_cFloor);
...
void CDlgVideoIntercomElevatorCfg::OnBtnGet() 
{
	...
	UpdateData(TRUE);
	DWORD dwReturn = 0;
    /*if (!NET_DVR_GetDVRConfig(m_lServerID, NET_DVR_GET_ELEVATORCONTROL_CFG_V40, 1, &m_struElevatorCfg, sizeof(m_struElevatorCfg), &dwReturn))
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_FAIL_T, "NET_DVR_GET_ELEVATORCONTROL_CFG_V40");
        return;
    }
    else
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_SUCC_T, "NET_DVR_GET_ELEVATORCONTROL_CFG_V40");
    }
	*/
	m_bEnable = m_struElevatorCfg.byEnable;
	//m_cFloor = m_struElevatorCfg.cFloor;
...
void CDlgVideoIntercomElevatorCfg::OnBtnSet() 
{
    ...
    //m_struElevatorCfg.cFloor = m_cFloor;
    ...
    /*(if (!NET_DVR_SetDVRConfig(m_lServerID, NET_DVR_SET_ELEVATORCONTROL_CFG_V40, 1, &m_struElevatorCfg, sizeof(m_struElevatorCfg)))
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_FAIL_T, "NET_DVR_SET_ELEVATORCONTROL_CFG_V40");
        return;
    }
    else
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_SUCC_T, "NET_DVR_SET_ELEVATORCONTROL_CFG_V40");
    }
	*/
}
