...
#ifdef DEMO_LAN_CN
static char *pCardType[] = { "未知卡", "普通卡", "残疾人卡", "黑名单卡" , "巡更卡", "胁迫卡", "超级卡", "来宾卡", "解除卡"};
#else
static char *pCardType[] = { "unknow", "normalcard", "disabledcard", "blacklistcard", "nightwatchcard", "stresscard", "supercard", "guestcard", "removecard" };
#endif
enum AddModeEum{
    SINGEL_ADD = 0,
    BATCH_ADD
