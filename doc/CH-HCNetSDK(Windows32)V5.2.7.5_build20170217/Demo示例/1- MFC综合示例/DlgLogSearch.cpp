...
void ParaTypeMap(const NET_DVR_LOG_V30 &stLogInfo, CString &szTemp)
{
...
Return:	none
**********************************************************/
void AlarmMinorTypeMap(const NET_DVR_LOG_V30 &stLogInfo, CString &szTemp)
{
    CString szParaType;
...
Return:	none
**********************************************************/
void ExceptionMinorTypeMap(const  NET_DVR_LOG_V30 &stLogInfo, CString &szTemp)
{
    CString szParaType;
    switch(stLogInfo.dwMinorType)
    {
...
Return:	none
**********************************************************/
void OperationMinorTypeMap(const NET_DVR_LOG_V30 &stLogInfo, CString &szTemp)
{
    CString szParaType;
    switch(stLogInfo.dwMinorType)
    {
...
void EventMinorTypeMap(const NET_DVR_LOG_V30 &stLogInfo, CString &szTemp)
{
    char  szLan[128];
    switch(stLogInfo.dwMinorType)
    {
