...
LONG CDlgOutput::MirrorStartPlay(PCHANNEL_INFO pChanInfo, HTREEITEM hChanItem)
{
    ...
    int iDeviceIndex = pChanInfo->iDeviceIndex;
    int iChanIndex   = pChanInfo->iChanIndex - MIRROR_CHAN_INDEX;
    CString csLog = _T("");
    StopPlay();
...
void CDlgOutput::OnRButtonDown(UINT nFlags, CPoint point)
{
    ...
    if( (m_lDeviceType == ATMDVR) || (m_lDeviceType == DS81XX_AH_S) || \
        (m_lDeviceType == IDS8104_AHL_S_H) || (m_lDeviceType == DS_81XXAH_ST) || (m_lDeviceType == DS_81XXAHF_ST) ||\
        (m_lDeviceType == DS_81XXAHW_ST) || (m_lDeviceType == DS_81XXAHW_SP) ||\
        (m_lDeviceType == DS_81XXAHWL_ST) || (m_lDeviceType == DS_81XXAHWL_SP) ||\
		(m_lDeviceType == IDS_81XXAHWL_ST) || (m_lDeviceType == IDS_81XXAHWL_SP) ||\
        (m_lDeviceType == DS_81XXAHGH_E4) || m_lDeviceType == IDS_2CD6812F_C) //ATM DVR
    {       
...
void CDlgOutput::OnMenuShowOSD()
{
    ...
    DWORD dwPRIDATA_RENDER =  PLAYM4_RENDER_ANA_INTEL_DATA  | PLAYM4_RENDER_MD | PLAYM4_RENDER_ADD_POS ;
    if (!m_bShowOSD)
    {
        if (lPlayerPort > -1)
        {
