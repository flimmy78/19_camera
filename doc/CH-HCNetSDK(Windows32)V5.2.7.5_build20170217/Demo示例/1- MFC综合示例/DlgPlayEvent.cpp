...
{
	LONG lRet = -1;
	NET_DVR_SEARCH_EVENT_RET_V40 struEventInfo;
	char szTmp[36] = {0};
	char szTmp1[36] = {0};
	char szDetail[256] = {0};
	char szLan[1024] = {0};
	...
	{
		memset(&struEventInfo, 0, sizeof(NET_DVR_SEARCH_EVENT_RET_V40));
		...
		{		
			...
			for (i=0; i<MAX_CHANNUM_V40; i++)
			{
                ...
                {
                    iSize++;
                    sprintf(szDetail+iSize*3, "%2d,", struEventInfo.wChan[i]);
                }
                else
                {
                    break;
...
void CDlgPlayEvent::OnBnClickedBtnRemoteSearchList()
{
	...
	if (!m_bSearching)
	{
		...
		m_struEventParamV40.wMajorType = m_iMajorType;
		
        int i = m_comboMinorEvent.GetCurSel();
		m_struEventParamV40.wMinorType = m_comboMinorEvent.GetItemData(i);
		m_struEventParamV40.struStartTime.dwYear = (WORD)m_ctDateStart.GetYear();
		m_struEventParamV40.struStartTime.dwMonth = (WORD)m_ctDateStart.GetMonth();
		m_struEventParamV40.struStartTime.dwDay = (WORD)m_ctDateStart.GetDay();
		m_struEventParamV40.struStartTime.dwHour = (char)m_ctTimeStart.GetHour();
		m_struEventParamV40.struStartTime.dwMinute = (char)m_ctTimeStart.GetMinute();
		m_struEventParamV40.struStartTime.dwSecond = (char)m_ctTimeStart.GetSecond();
		m_struEventParamV40.struEndTime.dwYear = (WORD)m_ctDateStop.GetYear();
		m_struEventParamV40.struEndTime.dwMonth = (WORD)m_ctDateStop.GetMonth();
		m_struEventParamV40.struEndTime.dwDay = (WORD)m_ctDateStop.GetDay();
		m_struEventParamV40.struEndTime.dwHour = (char)m_ctTimeStop.GetHour();
		m_struEventParamV40.struEndTime.dwMinute = (char)m_ctTimeStop.GetMinute();
		m_struEventParamV40.struEndTime.dwSecond = (char)m_ctTimeStop.GetSecond();
		...
		case EVENT_MOT_DET:
			...
			break;
		case EVENT_VCA_BEHAVIOR:
			m_struEventParamV40.uSeniorParam.struVcaParam.byRuleID = m_comboRuleID.GetItemData(m_comboRuleID.GetCurSel());
			break;
		case EVENT_STREAM_INFO:
			m_struEventParamV40.uSeniorParam.struStreamIDParam.struIDInfo.dwSize = sizeof(NET_DVR_STREAM_INFO);
			strncpy((char*)m_struEventParamV40.uSeniorParam.struStreamIDParam.struIDInfo.byID, m_strStreamID.GetBuffer(0), STREAM_ID_LEN);
			m_struEventParamV40.uSeniorParam.struStreamIDParam.struIDInfo.dwChannel = m_iRelatedChannel;
			m_struEventParamV40.uSeniorParam.struStreamIDParam.byBackupVolumeNum = (BYTE)m_dwBackupVolume;
			break;
        case EVENT_POS:
            m_struEventParamV40.uSeniorParam.struPosAlarm.byCaseSensitive = m_bCaseSensitive;
            m_struEventParamV40.uSeniorParam.struPosAlarm.byCombinateMode = m_bCombinateMode;
            strncpy((char*)m_struEventParamV40.uSeniorParam.struPosAlarm.sKeyWord[0], m_csKeyWord1.GetBuffer(0), STREAM_ID_LEN);
            strncpy((char*)m_struEventParamV40.uSeniorParam.struPosAlarm.sKeyWord[1], m_csKeyWord2.GetBuffer(0), STREAM_ID_LEN);
            strncpy((char*)m_struEventParamV40.uSeniorParam.struPosAlarm.sKeyWord[2], m_csKeyWord3.GetBuffer(0), STREAM_ID_LEN);
           m_struEventParamV40.uSeniorParam.struPosAlarm.wChannel[0] = 10;
            m_struEventParamV40.uSeniorParam.struPosAlarm.wChannel[1] = 11;
            m_struEventParamV40.uSeniorParam.struPosAlarm.byAllChan = 1;
            break;
        case EVENT_ACS_CASE:
            m_struEventParamV40.uSeniorParam.struACSAlarm.dwMajor = m_cmbMajorType.GetItemData(m_cmbMajorType.GetCurSel());
            m_struEventParamV40.uSeniorParam.struACSAlarm.dwMinor = m_cmbMinorType.GetItemData(m_cmbMinorType.GetCurSel());
            strncpy((char*)m_struEventParamV40.uSeniorParam.struACSAlarm.byCardNo, m_csCardNo.GetBuffer(0), ACS_CARD_NO_LEN);
            strncpy((char*)m_struEventParamV40.uSeniorParam.struACSAlarm.byName, m_csName.GetBuffer(0), NAME_LEN);
            StrToMac(sMac, m_struEventParamV40.uSeniorParam.struACSAlarm.byMACAddr);
            break;
		default:
			break;
		}
		...
		m_lFileHandle = NET_DVR_FindFileByEvent_V40(m_lLoginID, &m_struEventParamV40);
...
void CDlgPlayEvent::OnClickListChan(NMHDR* pNMHDR, LRESULT* pResult) 
{
	...
	switch(m_struEventParamV40.wMajorType)
	{
	case 0:    
        if (iMotDetChanNo < MAX_CHANNUM_V30)
        {
            m_struEventParamV40.uSeniorParam.struMotionParam.wMotDetChanNo[iMotDetChanNo++] = iData;
        }     
    ...
    case 1: 
        ...
        {
            m_struEventParamV40.uSeniorParam.struAlarmParam.wAlarmInNo[iAlarmInNo++] = iData;
        }
    ...
    case 2:  
        ...
        {
            m_struEventParamV40.uSeniorParam.struVcaParam.wChanNo[iVacChanNo++] = iData;
        }
	...
	case 4://智能侦测
        ...
        {
            m_struEventParamV40.uSeniorParam.struVCADetect.wChanNo[iVcaDetectNo++] = iData;
        }
    ...
    case EVENT_POS:
        ...
        {
            m_struEventParamV40.uSeniorParam.struVCADetect.wChanNo[iPosChanNo++] = iData;
        }
...
void CDlgPlayEvent::OnChkAllChan(BOOL bAll) 
{
    ...
    case EVENT_MOT_DET:
        for (i = 0; i<g_struDeviceInfo[m_iDeviceIndex].iDeviceChanNum; i++)//MAX_CHANNUM_V30
        {
            ...
            if (bAll)
            {
                m_struEventParamV40.uSeniorParam.struMotionParam.wMotDetChanNo[iChanIndex] = 1;
            }
            else
            {
                m_struEventParamV40.uSeniorParam.struMotionParam.wMotDetChanNo[iChanIndex] = 0xffff;
            }
    ...
    case EVENT_VCA_BEHAVIOR:
        for (i = 0; i<g_struDeviceInfo[m_iDeviceIndex].iDeviceChanNum+m_iIPChanNum; i++)//MAX_CHANNUM_V30
        {
            ...
            if (bAll)
            {
                m_struEventParamV40.uSeniorParam.struVcaParam.wChanNo[i] = iChanIndex; 
            }
            else
            {
                m_struEventParamV40.uSeniorParam.struVcaParam.wChanNo[i] = 0xffff;
            }
    ...
    case EVENT_ALARM_IN:
        for (i = 0; i<g_struDeviceInfo[m_iDeviceIndex].iAlarmInNum+m_iIPAlarmIn; i++)
        {
            ...
            if (bAll)
            {
                m_struEventParamV40.uSeniorParam.struAlarmParam.wAlarmInNo[i] = iChanIndex;
            }
            else
            {
                m_struEventParamV40.uSeniorParam.struAlarmParam.wAlarmInNo[i] = 0xffff;
            }
            if (iChanIndex == 128 -1)
            {
                break;
    ...
    case EVENT_VCA_DETECTION:
        for (i = 0; i < g_struDeviceInfo[m_iDeviceIndex].iDeviceChanNum; i++)
        {
            ...
            if (bAll)
            {
                m_struEventParamV40.uSeniorParam.struVCADetect.byAll = 1;
                m_struEventParamV40.uSeniorParam.struVCADetect.wChanNo[i] = iChanIndex;
            }
            else
            {
                m_struEventParamV40.uSeniorParam.struVCADetect.wChanNo[i] = 0xffff;
            }
            if (iChanIndex == 64 -1)
            {
                break;
    ...
    case EVENT_POS:
        for (i = 0 ;i <g_struDeviceInfo[m_iDeviceIndex].iDeviceChanNum;i++)
        {
            ...
            {
                m_struEventParamV40.uSeniorParam.struPosAlarm.byAllChan = 1;
                m_struEventParamV40.uSeniorParam.struPosAlarm.wChannel[i] = iChanIndex;;
            }
            else
            {
                m_struEventParamV40.uSeniorParam.struPosAlarm.wChannel[i] = 0xffff;
            }
...
void CDlgPlayEvent::UpdateMinorEvent()
{
	...
	case EVENT_ALARM_IN:
        ...
        GetDlgItem(IDC_STATIC_KEYWORD2)->ShowWindow(SW_HIDE);
        GetDlgItem(IDC_EDIT_KEYWORD4)->ShowWindow(SW_HIDE);
        GetDlgItem(IDC_STATIC_KEYWORD3)->ShowWindow(SW_HIDE);
    ...
    case EVENT_POS:
        ...
        GetDlgItem(IDC_STATIC_KEYWORD2)->ShowWindow(SW_SHOW);
        GetDlgItem(IDC_EDIT_KEYWORD4)->ShowWindow(SW_SHOW);
        GetDlgItem(IDC_STATIC_KEYWORD3)->ShowWindow(SW_SHOW);
