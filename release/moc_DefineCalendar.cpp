...
QT_MOC_LITERAL(6, 59, 10), // "SetNowTime"
QT_MOC_LITERAL(7, 70, 9), // "ClearTime"
QT_MOC_LITERAL(8, 80, 8), // "BtnSlots"
QT_MOC_LITERAL(9, 89, 13), // "ComboBoxSlots"
QT_MOC_LITERAL(10, 103, 13), // "CurPageChange"
QT_MOC_LITERAL(11, 117, 4), // "year"
QT_MOC_LITERAL(12, 122, 5) // "month"

    },
    "DefineCalendar\0setFinished\0\0dateTime\0"
    "UpdateYear\0UpdatePage\0SetNowTime\0"
    "ClearTime\0BtnSlots\0ComboBoxSlots\0"
    "CurPageChange\0year\0month"
};
...
void DefineCalendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DefineCalendar::*_t)(const QDateTime & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DefineCalendar::setFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DefineCalendar::staticMetaObject = {
    { &QCalendarWidget::staticMetaObject, qt_meta_stringdata_DefineCalendar.data,
      qt_meta_data_DefineCalendar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DefineCalendar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DefineCalendar.stringdata0))
        return static_cast<void*>(const_cast< DefineCalendar*>(this));
